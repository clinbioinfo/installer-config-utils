package InstallerConfig::Logger;
...
B<Description:> Instantiate InstallerConfig::Logger object

B<Parameters:> 

 %args

B<Returns:> Returns a reference to InstallerConfig::Logger
...
sub _initConfiguration {
    ...
    my $conf = q(
    log4perl.logger                    = sub {return InstallerConfig::Logger::_getLogLevel();}

    log4perl.appender.Logfile          = Log::Log4perl::Appender::File
    log4perl.appender.Logfile.filename = sub { return InstallerConfig::Logger::_getLogfile(); }
...
sub getInstance {
    ...
    if (!defined($instance)){
        ...
        $instance = new InstallerConfig::Logger(@_);

        if (!defined($instance)){
            confess "Could not instantiate InstallerConfig::Logger";
        }
    }
...
B<Description:> InstallerConfig::Logger class destructor
...
=head1 SYNOPSIS
 ...
 my $obj = InstallerConfig::Logger::getInstance();
